...
public class CollectionsOutputCreatorTest
{
	...
	private CollectionsOutputCreator sut = new CollectionsOutputCreator(mockOutputCreator);
	
	@Test
	public void calls_output_creator_with_correct_values()
	{
		sut.createOutput(asList("1", "2"), asList(1, 2));
	...
	public void creates_List_with_returned_values()
	{
		...
		List result = sut.createOutput(asList("1", "2"), asList(1, 2));
